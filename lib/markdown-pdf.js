...
function makePdf(inputHtml, outputPath){
  if(getExtension(outputPath) == "html"){
    console.log("Converted to html!");
    utf8 = '</style><head><meta charset="utf-8"/></head><body';
    newInputHtml = inputHtml.replace("</style><body", utf8);
    fs.writeFile(outputPath, newInputHtml);
    return;
  }
